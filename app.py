...
def accuracy_func_ui(time_step_dropdown, cx_dropdown, cy_dropdown, u_dropdown, v_dropdown):
  ...
  st.markdown("""<h1 style='text-align: center;font-size:18px;padding-top:0rem;padding-bottom:0rem;'>PINN and Math Model Simulation for &nbsp;&nbsp; - &nbsp;&nbsp; time steps 100 to {0} ; &nbsp;&nbsp;&nbsp;&nbsp; Source of pollution cx = {1} cy = {2} ; &nbsp;&nbsp;&nbsp;&nbsp; Velocity u = {3} v = {4}</h1>""".format(time_step_dropdown, cx_dropdown, cy_dropdown, u_dropdown, v_dropdown), unsafe_allow_html=True)
  ...
  pinn_final.markdown("<h1 style='text-align: center;font-size:15px;padding-top:0rem;padding-bottom:0rem;'>Time to generate PINN model {} milliseconds</h1>".format(str(round(pinn_time, 3))), unsafe_allow_html=True)
  ...
  math_final.markdown("<h1 style='text-align: center;font-size:15px;padding-top:0rem;padding-bottom:0rem;'>Time to generate math model {} milliseconds</h1>".format(str(round(math_time, 3))), unsafe_allow_html=True)
