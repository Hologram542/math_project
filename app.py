...
st.markdown("<h1 style='font-size:20px;padding-top:rem0;padding-bottom:rem0'>Enter the values for simulation</h1>", unsafe_allow_html=True)

time_step_dropdown = st.selectbox("Time step", np.arange(100, 1100, 100), index = 9)


st.markdown("<h1 style='font-size:15px;padding-top:rem0;padding-bottom:rem0'>Pollution Source Location</h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='font-size:15px;padding-top:rem0;padding-bottom:rem0'>velocity in x and y directions</h1>", unsafe_allow_html=True)
